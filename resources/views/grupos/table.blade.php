					...
					@foreach($grupo as $list)
						<tr>
							...
							<td class="text-center col-xs-1">
								<button type="button" value="{{ $list->id }}" class="edit-btn" data-toggle="modal" data-target="#edit-item2">
							...
							<td class="text-center col-xs-1">
								<button type="button" value="{{ $list->id }}" class="remove-btn" data-toggle="modal" data-target="#destroy-item2">
